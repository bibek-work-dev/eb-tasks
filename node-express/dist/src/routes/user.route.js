...
userRoutes.post("/forgot-password", (0, zodValidation_1.zodValidate)(validationSchemas_1.forgotPasswordSchema), userController.forgotPasswordController);
userRoutes.post("/reset-password", (0, zodValidation_1.zodValidate)(validationSchemas_1.resetPasswordSchema), userController.resetPasswordController);
userRoutes.patch("/change-password", requireAuth_1.default, userController.changePasswordController);
